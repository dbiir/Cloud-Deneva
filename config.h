...
//Storage
#define STORAGE_NODE_CNT NODE_CNT
#define STORAGE_THREAD_CNT 4
#define STORAGE_LOG_THREAD_CNT 3 // NOT working while STORAGE_ALL_IN_ONE is false
#define STORAGE_REM_THREAD_CNT 2
#define STORAGE_SEND_THREAD_CNT 2
#define STORAGE_ALL_IN_ONE true
#if !STORAGE_ALL_IN_ONE
  #define STORAGE_LOG_NODE_CNT 1
#else
  #define STORAGE_LOG_NODE_CNT STORAGE_NODE_CNT
#endif
